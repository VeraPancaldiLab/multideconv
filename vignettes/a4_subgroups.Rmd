...
`compute.subgroup.pathways()` expects a **pre-computed** sample × pathway numeric matrix. A popular choice is **PROGENy** (14 cancer-relevant signalling pathways), which can be computed using [CellTFusion](https://github.com/VeraPancaldiLab/CellTFusion):
